...
for i = 1:6
    if i >= 4 
        integ_network(1,i) = mean(features_response(i+1).integration_network.beta);
        integ_network(2,i) = mean(features_firstBlob(i+1).integration_network.beta);
    else
...
for i = 1:6
    if i >= 4 
        integ_network(1,i) = mean(features_response(i+1).integration_network.lowGamma);
        integ_network(2,i) = mean(features_firstBlob(i+1).integration_network.lowGamma);
    else
...
for i = 1:6
    if i >= 4 
        clust_coef(1,i) = mean(features_response(i+1).clustering_coef.beta);
        clust_coef(2,i) = mean(features_firstBlob(i+1).clustering_coef.beta);
    else
...
for i = 1:6
    if i >= 4 
        clust_coef(1,i) = mean(features_response(i+1).clustering_coef.lowGamma);
        clust_coef(2,i) = mean(features_firstBlob(i+1).clustering_coef.lowGamma);
    else
...
for i = 1:6
    if i >= 4 
        global_effic(1,i) = mean(features_response(i+1).global_effic.beta);
        global_effic(2,i) = mean(features_firstBlob(i+1).global_effic.beta);
    else
...
for i = 1:6
    if i >= 4 
        global_effic(1,i) = mean(features_response(i+1).global_effic.lowGamma);
        global_effic(2,i) = mean(features_firstBlob(i+1).global_effic.lowGamma);
    else
...
for i = 1:6
    if i >= 4 
        char_pl(1,i) = mean(features_response(i+1).char_pl.beta);
        char_pl(2,i) = mean(features_firstBlob(i+1).char_pl.beta);
    else
...
for i = 1:6
    if i >= 4 
        char_pl(1,i) = mean(features_response(i+1).char_pl.lowGamma);
        char_pl(2,i) = mean(features_firstBlob(i+1).char_pl.lowGamma);
    else
...
for i = 1:6
    if i >= 4 
        efficiency(1,i) = mean(features_response(i+1).efficiency.beta);
        efficiency(2,i) = mean(features_firstBlob(i+1).efficiency.beta);
    else
...
for i = 1:6
    if i >= 4 
        efficiency(1,i) = mean(features_response(i+1).efficiency.lowGamma);
        efficiency(2,i) = mean(features_firstBlob(i+1).efficiency.lowGamma);
    else
...
for i = 1:6
    if i >= 4 
        local_effic(1,i) = mean(mean(features_response(i+1).local_effic.beta));
        local_effic(2,i) = mean(mean(features_firstBlob(i+1).local_effic.beta));
    else
...
for i = 1:6
    if i >= 4 
        local_effic(1,i) = mean(mean(features_response(i+1).local_effic.lowGamma));
        local_effic(2,i) = mean(mean(features_firstBlob(i+1).local_effic.lowGamma));
    else
...
betweenness(1) = mean(features_3.betweenness.beta);
betweenness(2) = mean(features_4.betweenness.beta);
betweenness(3) = mean(features_5.betweenness.beta);
betweenness(4) = mean(features_6.betweenness.beta);
betweenness(5) = mean(features_7.betweenness.beta);
betweenness(6) = mean(features_8.betweenness.beta);
betweenness(7) = mean(features_9.betweenness.beta);
figure;
scatter(blobs,betweenness,'red','filled');
title('betweenness based on blobs beta');
xlabel('Blobs');
ylabel('betweenness of network');
grid on

betweenness = zeros(num_blobs,1);
betweenness(1) = mean(features_3.betweenness.lowGamma);
betweenness(2) = mean(features_4.betweenness.lowGamma);
betweenness(3) = mean(features_5.betweenness.lowGamma);
betweenness(4) = mean(features_6.betweenness.lowGamma);
betweenness(5) = mean(features_7.betweenness.lowGamma);
betweenness(6) = mean(features_8.betweenness.lowGamma);
betweenness(7) = mean(features_9.betweenness.lowGamma);
figure;
scatter(blobs,betweenness,'red','filled');
title('betweenness based on blobs gamma');
xlabel('Blobs');
ylabel('betweenness of network');
grid on
